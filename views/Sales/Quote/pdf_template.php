        ...
        <div id="invoice-section"></div>
          ...
          <div id="invoice-company-details" class="row mt-2">
            ...
            <div class="col-md-6 text-md-right">
              <h2>QUOTE</h2>
              <p>SRN #<?= htmlspecialchars($quotes['quote_number']) ?></p>
               <p>Reference:<?= htmlspecialchars($quotes['reference']) ?></p>
              <ul class="list-unstyled">
                ...
                <?php if($quotes['currency'] == 1){
                    ...
                    $currencySymbol = "Your Currency";
                }
                ?>
                <li class="lead text-bold-800"><?= $currencySymbol ?> <?= number_format($quotes['grand_total'], 2) ?></li>
              </ul>
            </div>
          </div>
          ...
          <div id="invoice-customer-details" class="row pt-2">
            ...
            <div class="col-md-4">
              <p>Quote Date: <?= date('d-m-Y', strtotime($quotes['quote_date'])) ?></p>
              <p>Due Date: <?= date('d-m-Y', strtotime($quotes['due_date'])) ?></p>
          ...
          <div id="invoice-items-details" class="pt-2">
            <div class="row">
              <div class="col-sm-12 table-responsive" style="width: 100%important; margin-top: 20px !important;">
            ...
            <div class="row mt-3">
              <div class="col-md-7">
                <p class="lead">Payment Status: <strong><?= $quotes['status'] ?? 'Pending' ?></strong></p>
             
                <p class="lead mt-1">Note:</p>
                <code><?= $quotes['note'] ?? 'No notes provided.' ?></code>
              </div>
              <div class="col-md-5">
