                            ...
                            <div class="card-block">
                                <div class="media">
                                    <div class="media-body text-xs-left">
                                        <h3 class="pink" id="dash_0"><?= $waitingCount ?? 0 ?></h3>
                                        <span>Waiting</span>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-block">
                                <div class="media">
                                    <div class="media-body text-xs-left">
                                        <h3 class="indigo" id="dash_1"><?=  $processingCount ?? 0 ?></h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-block">
                                <div class="media">
                                    <div class="media-body text-xs-left">
                                        <h3 class="green" id="dash_2"><?= $solvedCount ?? 0 ?></h3>
                                        <span>Solved</span>
                                    </div>
                                    <div class="media-right media-middle">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-block">
                                <div class="media">
                                    <div class="media-body text-xs-left">
                                        <h3 class="deep-cyan"><?= $waitingCount + $processingCount + $solvedCount  ?? 0 ?></h3>
                                        <span>Total</span>
                                    </div>
                                    <div class="media-right media-middle">
...
<script>
$(document).ready(function () {
  $('#cgrtable').on('click', '.delete-object', function (e) {
    e.preventDefault();
    const id = $(this).data('object-id');
    if (confirm("Are you sure you want to delete this Group?")) {
      $.ajax({
        url: `/AIS/group-delete?id=${id}`,
        type: 'GET',
        dataType: 'json',
        success: function (response) {
          if (response.status === 'success') {
            alert(response.message);
            $('#cgrtable').DataTable().ajax.reload(null, false);
          } else {
