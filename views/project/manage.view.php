...
<script type="text/javascript">
    $(document).ready(function () {
        $('#doctable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "/AIS/support-manage-ajaxList",
                "type": "GET"
            },
            "columnDefs": [
                {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if ($.fn.DataTable.isDataTable('#doctable')) {
                    $('#doctable').DataTable().ajax.reload(null, false);
                } else {
                    // Or just remove the row manually if not using DataTables
                    $(`#row-${id}`).remove();
                }
            },
            error: function () {
