...
<body data-open="click" data-menu="vertical-menu" data-col="2-columns"
      class="vertical-layout vertical-menu 2-columns  fixed-navbar"><span id="hdata" data-df="dd-mm-yyyy"
                                                                          data-curr="$"></span>
        ...
        <form method="post" id="product_action" class="form-horizontal">
            <div class="grid_3 grid_4">
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-4 col-form-label"
                           for="product_name">Date Format(Billing)</label>

                    <div class="col-sm-4"><select name="dateformat" class="form-control">

                            <option value="1">*DD-MM-YYYY*</option>                            <option value="1">DD-MM-YYYY</option>
