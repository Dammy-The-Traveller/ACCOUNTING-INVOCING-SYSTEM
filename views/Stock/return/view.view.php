        ...
        <section class="card">
          <div id="invoice-template" class="card-block">
            <div class="row wrapper white-bg page-heading">
              <div class="col-lg-12">
                ...
                <?php if($return['status'] !== 'cancelled'): ?>
                  <a href="/AIS/return?id=<?= $return['id'] ?>" class="btn btn-warning"><i class="icon-pencil"></i> Edit Order </a>
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu"><a href="#sendEmail" data-toggle="modal" data-remote="false" class="dropdown-item sendbill" data-type="return">return Request</a>
                    </div>
                  </div>
                  <div class="btn-group ">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="/AIS/return-print?id=<?= $return['id'] ?>">Print</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="/AIS/return-download?id=<?= $return['id'] ?>">PDF Download</a>
                    </div>
                  </div>
                  <a href="/AIS/public-return?id=<?= $return['id'] ?>" class="btn btn-primary"><i class="icon-earth"></i> Public Preview </a>
            ...
            <div id="invoice-customer-details" class="row pt-2">
              ...
              <div class="col-md-6 col-sm-12 text-xs-center text-md-left">
                <ul class="px-0 list-unstyled">
                  <li class="text-bold-800"><a href="/AIS/supplier-view?id=<?= $return['supplier_id']  ?>"><strong
              ...
              <div class="offset-md-3 col-md-3 col-sm-12 text-xs-center text-md-left">
                <p><span class="text-muted">Order Date :</span> <?= date('d-m-Y', strtotime($return['invoice_date'])) ?></p>
                <p><span class="text-muted">Due Date :</span> <?= date('d-m-Y', strtotime($return['due_date'])) ?></p>
            ...
            <div id="invoice-items-details" class="pt-2">
              ...
              <div class="row">
                <div class="col-md-7 col-sm-12 text-xs-center text-md-left">
                  <div class="row">
                    <div class="col-md-8">
                      <p class="lead">Return Status:
                        <u><strong id="pstatus"><?= $return['status'] ?? 'Unpaid' ?></strong></u>
                      </p>
                      <p class="lead">Payment Method: <u><strong id="pmethod"><?= $return['payment_method'] ?? 'Unpaid' ?></strong></u>
                      </p>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      <tbody>
                        <tr>
                          <td>Sub Total</td>
                          <td class="text-xs-right"><?= $currencySymbol ?> <?= number_format($item['subtotal'], 2) ?></td>
                        </tr>
                        <tr>
                          <td>TAX</td>
                          <td class="text-xs-right"><?= $currencySymbol ?> <?= number_format($item['tax_amount'], 2) ?></td>
                        </tr>
                        <tr>
                          <td> Shipping</td>
                          <td class="text-xs-right"><?= $currencySymbol ?> <?= number_format($return['shipping'], 2) ?></td>
                        </tr>
                        <tr>
                          <td class="text-bold-800">Total</td>
                          <td class="text-bold-800 text-xs-right"><?= $currencySymbol ?> <?= number_format($return['grand_total'], 2) ?></td>
                        </tr>
                        <tr>
                          <td>Payment Made</td>
                          <td class="pink text-xs-right">
                            (-) <span id="paymade"><?= $currencySymbol ?> <?= number_format($payment['amount'] ?? 0, 2) ?></span></td>
                        </tr>
                        <tr class="bg-grey bg-lighten-4">
                          <td class="text-bold-800">Balance Due</td>
                          <td class="text-bold-800 text-xs-right"> <span id="paydue"><?= $currencySymbol ?> <?= number_format(($return['grand_total'] - ($payment['amount'] ?? 0)), 2) ?></span></strong></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
            ...
            <div class="row">
              <div class="col-xs-12 mb-1"><label for="pmethod">Payment Method</label>
                ...
                <select name="account" class="form-control">
                  ...
                  <option value="6">return A/C / 1234567890</option>
                </select>
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12 mb-1"><label for="shortnote">Note</label>
                <input type="text" class="form-control" name="shortnote" placeholder="Short note" value="Payment for return #1045">
              </div>
            </div>
  ...
  <div id="pop_model" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="form_model" action="/AIS/return-update-status" method="POST">
            <div class="row">
            ...
            <div class="modal-footer">
              <input type="hidden" class="form-control required" name="tid" id="invoiceid" value="<?= $return['id'] ?>">
              <button type="button" class="btn btn-default" data-dismiss="modal"> Close</button>
              <input type="hidden" id="action-url" value="return/update_status">
  ...
  <div id="pop_model2" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="form_model" action="/AIS/return-status" method="POST">
            <div class="row">
              <div class="col-xs-12 mb-1"><label for="pmethod">Mark As</label>
                <select name="status" class="form-control mb-1">
