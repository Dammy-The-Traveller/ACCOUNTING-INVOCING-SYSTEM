...
<article class="content">
    <div class="card card-block">
        ...
        <div class="grid_3 grid_4">
            ...
            <form method="post" id="data_form" class="form-horizontal" action="<?= $isEdit ? '/AIS/stock-warehouses-update' : '/AIS/stock-warehouses-store' ?>">
            <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?>">
            <input type="hidden" name="warehouse_id" value="<?= $isEdit ? $warehouses['id'] : '' ?>">
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 col-form-label"
                           for="product_catname">Warehouse Name</label>

                    <div class="col-sm-6">
                        <input type="text" placeholder="Warehouse Name"
                               class="form-control margin-bottom  required" name="product_catname" value="<?= $isEdit ? $warehouses['name'] : '' ?>">
                    </div>
                </div>
                <div class="form-group row">

                    <label class="col-sm-2 col-form-label"
                           for="product_catname">Location</label>

                    <div class="col-sm-6">
                        <input type="text" placeholder="Warehouse Location"
                               class="form-control margin-bottom required" name="product_catdesc" value="<?= $isEdit ? $warehouses['location'] : '' ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="warehouse_status" class="form-control">
                            <option value='active' <?= $isEdit && $warehouses['status'] == 'active' ? 'selected' : '' ?>>Active</option>                        
                            <option value='inactive' <?= $isEdit && $warehouses['status'] == 'inactive' ? 'selected' : '' ?>>Inactive</option>                        
                        </select>
                    </div>
                </div>
                <div class="form-group row">
